...
METRICS: list[MetricDef] = [
    MetricDef("L_actual_uH",       "L atual",            "µH",    "{:.0f}", "neutral"),
    MetricDef("N_turns",           "N voltas",           "",      "{:.0f}", "lower"),
    MetricDef("mu_pct_at_peak",    "μ% no pico",         "",      "{:.2f}", "higher"),
    MetricDef("Volume_cm3",        "Volume",             "cm³",   "{:.1f}", "lower"),
    MetricDef("I_line_pk_A",       "I pico linha",       "A",     "{:.2f}", "neutral"),
    MetricDef("I_line_rms_A",      "I RMS linha",        "A",     "{:.2f}", "neutral"),
    MetricDef("I_ripple_pk_pk_A",  "Ripple máx pp",      "A",     "{:.2f}", "lower"),
    MetricDef("I_pk_max_A",        "I pico total",       "A",     "{:.2f}", "lower"),
    MetricDef("H_dc_peak_Oe",      "H pico DC",          "Oe",    "{:.0f}", "lower"),
    MetricDef("B_pk_T",            "B pico",             "T",     "{:.3f}", "lower"),
    MetricDef("sat_margin_pct",    "Margem Bsat",        "%",     "{:.0f}", "higher"),
    ...
    MetricDef("P_core_line_W",     "P núcleo (rede)",    "W",     "{:.3f}", "lower"),
    MetricDef("P_core_ripple_W",   "P núcleo (ripple)",  "W",     "{:.3f}", "lower"),
    MetricDef("P_total_W",         "P total",            "W",     "{:.2f}", "lower"),
    MetricDef("T_rise_C",          "ΔT",                 "K",     "{:.0f}", "lower"),
    MetricDef("T_winding_C",       "T enrolamento",      "°C",    "{:.0f}", "lower"),
    MetricDef("Window_use_pct",    "Ku atual",           "%",     "{:.1f}", "lower"),
]
