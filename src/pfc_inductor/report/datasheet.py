...
<div class="sheet">
  <div class="header">
    <div class="title">
      <h1>{escape(title)}</h1>
      <h2>Custom design — generated by PFC Inductor Designer</h2>
    </div>
    <div class="meta">
...
<div class="sheet">
  ...
  <h2>Disclaimer</h2>
  <div class="note">
    This datasheet describes a custom inductor designed by the
    PFC&nbsp;Inductor&nbsp;Designer tool. Curated material parameters
    come from manufacturer datasheets and Steinmetz fits to vendor
    data; cores and wires are dimensional database entries. Always
    verify against a built sample (LCR meter for L &amp; Rdc, dyno-loaded
    operation for thermal) before committing to production.
  </div>

  <p style="margin-top:24px; font-size:9.5px; color:#888;">
    Generated by PFC Inductor Designer · {now}
  </p>
</div>
